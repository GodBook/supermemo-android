...
- **长按事项快捷操作 (v1.1.1 新增)**：长按卡片中的任意待办项，即时弹出快捷操作浮窗，支持一键切换为待办、标记为已完成、或彻底删除该条事项。
- **待办事项呼吸闪烁提醒 (v1.1.1 新增)**：在「设置」中可选择开启呼吸闪烁动效，并从 6 种醒目颜色（活力橙、热情红、荧光绿、电光蓝、霓虹紫、亮丽黄）中自定义专属闪烁色彩，未完成待办事项平滑优雅呼吸闪烁，吸睛提醒进度。
